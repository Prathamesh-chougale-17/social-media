...
When generating tasks, ensure adherence to these principles and reference `.github/prompts/speckit.social-media-implementation.prompt.md` for implementation patterns.
