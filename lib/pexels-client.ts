...
export class PexelsClient {
   ...
   */
  async fetchPopularVideos(page: number = 1, perPage: number = 20): Promise<PexelsVideo[]> {
    // Apply rate limiting
   ...
   * @returns Array of Pexels videos
   */
  async searchVideos(query: string, page: number = 1, perPage: number = 20): Promise<PexelsVideo[]> {
    await pexelsRateLimiter.throttle();
