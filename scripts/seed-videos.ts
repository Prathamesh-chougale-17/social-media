  ...
  try {
    ...
    for (let page = 1; page <= pagesToSync; page++) {
      ...
      try {
        ...
        console.log(`   ✅ Synced: ${syncedCount} | Skipped: ${skippedCount} | Errors: ${transformErrors}\n`);
    ...
    console.log(`   Total skipped: ${totalSkipped} videos (already in database)`);
    console.log(`   Total errors: ${totalErrors} videos (transformation failed)`);
    console.log(`   Total processed: ${totalSynced + totalSkipped + totalErrors} videos\n`);
